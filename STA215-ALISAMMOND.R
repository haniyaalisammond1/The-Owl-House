...
mean(data$Q_Rel_Crsh_Ment_Var_2)
sd(data$Q_Rel_Crsh_Ment_Var_2)
table(data$Q_Rel_Crsh_Ment_Var_2)
describe(data$Q_Rel_Crsh_Ment_Var_2)
summary(data$Q_Rel_Crsh_Ment_Var_2)
